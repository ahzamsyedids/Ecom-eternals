        ...
        <section className="relative pt-40 pb-28 overflow-hidden bg-gradient-to-b from-[#CDD9FE] via-white to-[#D4B3FF21]">
            <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center relative z-10">
                ...
                <p className="text-lg md:text-xl text-gray-600 max-w-3xl mx-auto leading-relaxed">
                    Choose the right package based on your goals and budget. Every plan is designed to help you build, launch, and scale a profitable ecommerce store with expert support.                </p>
            </div>
